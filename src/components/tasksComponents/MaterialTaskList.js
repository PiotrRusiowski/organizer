...
const MaterialTaskList = ({ taskList, deleteTasks }) => {
  ...
  const handleSelectAllClick = (event) => {
    if (event.target.checked) {
      const newSelecteds = taskList.map((task) => task.id);
                ...
                .map((task, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">{task.finishDate}</TableCell>
...
const mapDispatchToProps = (dispatch) => ({
  deleteTasks: (taskIds) => dispatch(deleteTasks(taskIds)),
});

export default connect(mapStateToProps, mapDispatchToProps)(MaterialTaskList);
